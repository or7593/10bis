...
public class LoginTest {
	 ...
	 *  	Then: Getting into login page
	 */

	@Test(priority = 1, enabled = true, description = "Go to the login page")
	public void ClickOnLogin() throws InterruptedException, IOException, ParserConfigurationException, SAXException {

		logger.info("Going to login page");
		Assert.assertTrue(main.login());

		logger.info("Successfully Get login page");

	}
	

	/*  Prerequisite: getting into https://www.10bis.com/
	 * 		Given: Client login page 
	 * 		When: Click to connect from Facebook
	...
	public void LoginUsingFacebook()
		...
		logger.info("Going to connection page using Facebook ");
		Assert.assertTrue(login.doLoginFacebook(userName, password, name));
